...
import { createComment, createPost, createStory, createUserAccount, createVideoPost, deleteComment, deletePost, deleteSavedPost, followUser, getCurrentUser, getInfinitePosts, getPostById, getRecentComments, getRecentPosts, getRecentStories, getStoryById, getUserById, getUsers, likePost, savePost, searchPosts, signInAccount, signOutAccount, updatePost, updateUser, updateVideoPost } from '../app-write/api';
...
export const useDeleteStory = () => {
  ...
  return useMutation({
    mutationFn: (storyId, imageId) => deletePost(storyId, imageId),
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: ['getStoryById']
      })
    }
  })
}
